		...
		<div id="container">
			<div id="page">
				...
				<div id="content">
					<div id="leftCol">
						<ul id="steps">
							<li<? if ($actual_step == 1) { echo " class=\"current\""; } ?>>1. Update Database Connection</li>
							<li<? if ($actual_step == 2) { echo " class=\"current\""; } ?>>2. Update Database Tables</li>
							<li<? if ($actual_step == 3) { echo " class=\"current\""; } ?>>3. Finish</li>
						</ul>
					</div>
					<div id="rightCol">
